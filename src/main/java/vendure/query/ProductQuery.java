...
public class ProductQuery extends GraphQlQuery<Product> {
    ...
    public static ProductQuery byId(String id)     { return new ProductQuery(id, null); }
    public static ProductQuery bySlug(String slug) { return new ProductQuery(null, slug); }
